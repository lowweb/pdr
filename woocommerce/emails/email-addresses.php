...
?><div id="addr-wrap"><table id="addresses" cellspacing="0" cellpadding="0" style="width: 100%; vertical-align: top;" border="0">
	<tr>
		<td class="td" style="text-align:<?php echo $text_align; ?>; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" valign="top" width="50%">
			<h3 style="font-weight:300; font-size:18px;"><?php _e( 'Billing address', 'woocommerce' ); ?></h3>
